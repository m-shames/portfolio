...
Provided statistical analyses and data monitoring for civil rights litigation 
challenging solitary confinement practices in New York State.  
...
- "Solitary confinement by the numbers: Settlement compliance in *Peoples v. Annucci*"    
  [Data overview presented annually to NY DOCCS leadership, 2017–2023]  
...
*Peoples v. Annucci* settlement.

> Code samples for this project are available upon request. Underlying data are confidential.
